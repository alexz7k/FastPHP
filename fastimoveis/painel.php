        ...
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown">
                    ...
                    <div class="ms-3">
                    <a href="calculadora.php">Calculadora de Valores Imobiliarios</a><br> 
                    </div>      
                </div>
            </div>
        </div>
...
<form method="post" action="addRecord.php">
    ...
    <div class="modal-body">
        ...
        <div class="mb-3">
            <label for="nomeVendedor" class="form-label">Nome do Vendedor (Proprietário):</label>
            <textarea class="form-control" id="nomeVendedor" name="nomeVendedor" rows="3"></textarea>
        </div>
        <div class="mb-3">
            <label for="telefoneVendedor" class="form-label">Telefone do Vendedor (Proprietário):</label>
            <textarea class="form-control" id="telefoneVendedor" name="telefoneVendedor" rows="3"></textarea>
        </div>
        <div class="mb-3">
            <label for="emailVendedor" class="form-label">Email do Vendedor (Proprietário):</label>
            <textarea class="form-control" id="emailVendedor" name="emailVendedor" rows="3"></textarea>
        </div>
        <div class="mb-3">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?= $row['endereco'] ?></td>
                        <td><?= $row['categoria'] ?></td>
                        <td><?php echo strval($row['preco']); #convertendo para string ?></td> 
...
<?php } // Adicione esta chave de fechamento ?>
